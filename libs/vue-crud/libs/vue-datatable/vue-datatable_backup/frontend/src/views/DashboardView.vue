...
async function loadStats() {
  try {
    ...
    stats.value[0].count = Array.isArray(a.data) ? a.data.length : 0
    stats.value[1].count = Array.isArray(s.data) ? s.data.length : 0
    stats.value[2].count = Array.isArray(b.data) ? b.data.length : 0
